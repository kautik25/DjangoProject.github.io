...
class PaymentMethod(models.Model):
    ...
    method_type = models.CharField(max_length=255, choices=[('Account', 'Paybill Account'), ('Card', 'Cards'), ('Bank', 'Bank')], default=None)
...
class Transaction(models.Model):
    ...
    checksum = models.CharField(max_length=100, null=True, blank=True) #paytm transaction
